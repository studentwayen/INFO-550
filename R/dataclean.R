...
here::i_am("R/dataclean.R")

#read data
prodat<-read.csv(here::here("data","rapi.csv"))
amountdat<-read.csv(here::here("data","namount.csv"))
...
# save data
write.csv(mydata, file=here::here("data.csv"), quote = FALSE, row.names = FALSE)
